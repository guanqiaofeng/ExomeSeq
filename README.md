...
touch command requied

In `ref/` folder
```
touch BWAgenome.fa Mills_and_1000G_gold_standard.indels.hg38.vcf 1000G_phase1.snps.high_confidence.hg38.vcf genome.fa dbsnp_144.hg38.vcf
```
In `resources/` folder
```
